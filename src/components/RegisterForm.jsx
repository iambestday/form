      ...
      <div className="mx-auto max-w-lg">
        ...
        >
          <p className="text-center text-sm font-medium">
            لطفا مشخصات خواسته شده را با دقت وارد کنید
          </p>
          ...
          <div>
            <label for="domain" className="sr-only">
              Domain
            </label>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                rules={{ required: "آدرس IP الزامی است" }}
              />
          ...
          <button
            type="submit"
            className="block w-full rounded-lg bg-indigo-600 px-5 py-3 text-lg font-medium text-white"
          >
            ثبت
          </button>
        </form>
